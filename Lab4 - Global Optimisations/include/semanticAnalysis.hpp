...
std::vector<std::string> getFuncDeclParams(treeNode* func_node,
                                           std::string type);
...
extern bool checkDeclUse(treeNode* node, std::string curr_type,
                         std::stack<scope>& scope);
extern std::string checkType(treeNode* node, std::string curr_type,
                             std::stack<scope>& scope);
